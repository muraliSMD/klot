...
async function analyze() {
  try {
    ...
    if (prediction) {
        console.log("\n--- Prediction Data ---");
        console.log("Predicted Numbers:", prediction.predictedNumbers);
        console.log("3-Digit Patterns:", prediction.threeDigit);
        console.log("Algorithms:", prediction.algorithms);
        console.log("Guessing Board:", prediction.guessingBoard);
    } else {
